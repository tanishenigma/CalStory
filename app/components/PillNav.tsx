  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 z-200 lg:hidden w-10 h-10 rounded-xl bg-background border border-border shadow-[0_4px_24px_rgba(0,0,0,0.07)] dark:shadow-none flex items-center justify-center"
        aria-label="Open menu">
        <Menu size={18} className="text-[#1A1916] dark:text-[#f7f6f3]" />
      </button>
...
function FloatingSidebar({ pathname }: { pathname: string }) {
  ...
  return (
    <>
      ...
      <button
        onClick={() => setMobileOpen(true)}
        className="fixed top-4 left-4 z-[200] lg:hidden w-10 h-10 rounded-xl bg-foreground/80 backdrop-blur-2xl border border-white/60 dark:border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.08)] flex items-center justify-center"
        aria-label="Open menu">
        <Menu size={18} className="text-[#1A1916] dark:text-[#f7f6f3]" />
      </button>
