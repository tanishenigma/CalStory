  ...
  return (
    <section className="relative z-10 py-32 px-6 w-full overflow-hidden">
      <BlurFade delay={0.1} className="w-full flex justify-center">
        <Card className="relative w-full max-w-5xl rounded-[32px] overflow-hidden card-elevated backdrop-blur-3xl px-8 py-24 text-center group mx-auto">
          {/* Atmospheric backgrounds */}
          <div className="absolute inset-0 bg-gradient-to-br from-orange-500/10 via-transparent to-orange-500/5 pointer-events-none rounded-[32px]" />
          <div className="absolute inset-0 bg-noise opacity-[0.03] pointer-events-none" />

          {/* Decorative glow */}
          <div className="absolute -top-24 -left-24 w-64 h-64 bg-orange-500/10 blur-[100px] rounded-full pointer-events-none group-hover:bg-orange-500/15 transition-colors duration-700" />
          ...
          <CardContent className="relative z-10 space-y-8 w-full p-0">
            {!hasProfile && (
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-500/10 border border-orange-500/20 text-[10px] font-bold uppercase tracking-widest text-orange-600 mx-auto">
                <Sparkles size={12} />
            ...
            <div className="flex items-center justify-center gap-4 pt-4 w-full">
              <button
                ...
                className="h-14 px-10 rounded-2xl bg-foreground text-background text-base font-bold hover:scale-[1.02] active:scale-[0.98] transition-all cursor-pointer inline-flex items-center gap-2.5 shadow-xl hover:shadow-2xl hover:shadow-orange-500/10">
