const CLIENT_ID = process.env.FATSECRET_CLIENT_ID || "72e3be5c0b6c420b80958a9097fc2647";
const CLIENT_SECRET = process.env.FATSECRET_CLIENT_SECRET || "9975c0298b8b4241bd78f28e6c83e7c1";
