...
export function GoalsTab({
  ...
  const targetWeightKg =
    targetWeightInput.trim() === ""
      ? undefined
      : weightUnit === "lbs"
        ? lbsToKg(Number(targetWeightInput))
...
function ActivitySection({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      <Card className="p-6">
        <div className="text-sm font-bold mb-2">Steps per Day</div>
      ...
      <Card className="p-6">
        <div className="text-sm font-bold mb-2">Workouts per Week</div>
      ...
      <Card className="p-6">
        <div className="text-sm font-bold mb-2">Target Weight</div>
        <div className="relative">
          <input
            type="number"
            step="0.1"
        ...
        <p className="text-xs text-muted-foreground mt-4 leading-relaxed">
          The weight you&apos;re working toward. Shown on the Progress page.
        </p>
      </Card>
    </div>
  );
