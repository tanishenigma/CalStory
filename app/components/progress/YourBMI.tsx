...
export function YourBMI() {
  ...
  return (
    <Card className="overflow-hidden">
      <CardTitle className="text-lg p-5 ">Your BMI</CardTitle>
      <CardContent className="p-6">
        ...
        <div className="relative w-full h-3 rounded-full bg-gradient-to-r from-blue-400 via-green-400 via-yellow-400 to-red-500 mb-2">
          {/* Indicator */}
          <div
            className="absolute top-1/2 -translate-y-1/2 w-5 h-5 bg-card border-2 border-[#1A1916] dark:border-[#f7f6f3] rounded-full shadow-sm transition-all duration-500"
