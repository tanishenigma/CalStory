          ...
          <div className="space-y-8 text-muted-foreground leading-relaxed">
            <section>
              ...
              <p>
                ...
                ; together they describe what data is stored on your device and
            ...
            <section>
              ...
              <ul>
                <li>
                  <code>firebase:authUser:</code> — Firebase Auth session token.
                  Lets you stay signed in across page refreshes. Set by
                ...
                <li>
                  ...
                  the dashboard render instantly while the real data loads from
                  Firestore.
                </li>
                <li>
              ...
              <ul>
                <li>
                  ...
                  preference (light / dark / system). Used to render the correct
                  palette on the next page load.
                </li>
                <li>
                ...
                <li>
                  <code>gemini_api_key</code> — your personal Gemini API key, if
                  you chose to use one. Stored in your browser only; never sent
                  to any CalStory-controlled server. Lives under{" "}
                  <code>localStorage</code> encrypted with your user-id-derived
                  key.
                </li>
              </ul>
            ...
            <section>
              ...
              <ol>
                ...
                <li>
                  Go to <strong>Application → Local Storage</strong> (or Storage
                  in Firefox).
                </li>
                <li>
            ...
            <section>
              ...
              <ul>
                ...
                <li>
                  ...
                  may log requests; the CSS is inlined on the landing page where
