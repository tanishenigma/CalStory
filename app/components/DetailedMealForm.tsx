      ...
      <div className="w-full max-w-sm mx-4 sm:mx-auto bg-card rounded-[24px] p-4 sm:p-6 shadow-xl animate-in zoom-in-95 duration-200">
        ...
        <div className="space-y-4">
          <div className="relative">
            ...
            <button
              type="button"
              className="absolute right-0 bottom-1.5 text-muted-foreground hover:text-foreground transition-colors">
              ...
              <div className="flex flex-wrap gap-2">
                {state.recents.slice(0, 4).map((r) => (
                  <button
                    ...
                    className="px-3 py-1.5 bg-background hover:bg-muted rounded-lg text-[11px] font-bold text-foreground transition-colors">
                    {r.name}
                  </button>
                ))}
              </div>
