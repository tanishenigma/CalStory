          ...
          <BlurFade
            ...
            <div className="space-y-8 text-muted-foreground-foreground leading-relaxed">
              <section>
                ...
                <p>
                  At CalStory, we take your privacy seriously. This Privacy
                  Policy explains how we collect, use, disclose, and safeguard
                  your information when you visit our application. Please read
              ...
              <section>
                ...
                <ul className="list-disc pl-6 mt-4 space-y-2">
                  <li>
                    ...
                    profile picture provided through third-party authentication
                    services (e.g., Google).
                  </li>
                  <li>
                    <strong>Health Data:</strong> To provide our core services,
                    we collect data such as weight, height, age, meal logs, and
                    workout history.
                  </li>
                  <li>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 mt-4 space-y-2">
                  ...
                  <li>
                    ...
                    for us or on our behalf, including data analysis, email
                    delivery, hosting services, and customer service (e.g.,
              ...
              <section>
                ...
                <p>
                  ...
                  delete your personal data. You can manage your data within the
