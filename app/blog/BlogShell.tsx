      ...
      <div className="relative min-h-screen bg-background text-foreground font-sans selection:bg-primary/30">
        ...
        <BlurFade>
          <main className="relative z-10 pt-32 pb-24 px-6 max-w-3xl mx-auto w-full">
            <Link
              href="/"
              className="inline-flex items-center gap-2 text-sm text-muted-foreground-foreground hover:text-foreground transition-colors mb-8">
              <ArrowLeft size={14} />
              Back
            </Link>
            ...
            <div className="flex items-center gap-3 text-sm text-muted-foreground-foreground mb-10">
            ...
            <p className="text-lg md:text-xl text-muted-foreground-foreground leading-relaxed mb-12">
              {intro}
            </p>

            <article className="prose prose-neutral dark:prose-invert max-w-none prose-headings:font-heading prose-headings:tracking-tight prose-h2:text-3xl prose-h2:mt-12 prose-h2:mb-4 prose-h3:text-xl prose-h3:mt-8 prose-h3:mb-3 prose-p:leading-relaxed prose-p:text-muted-foreground-foreground prose-li:text-muted-foreground-foreground prose-a:text-primary hover:prose-a:text-primary/80">
              {children}
            </article>
